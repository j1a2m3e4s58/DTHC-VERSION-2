...
class FoodCard extends StatefulWidget {
  ...
  final bool preferExpandedImage;
  ...
  const FoodCard({
    ...
    this.onAddToCart,
    this.onGoToCart,
    this.preferExpandedImage = false,
  });
...
class _FoodCardState extends State<FoodCard> {
  ...
  ProductItem get _selectedProductForCart =>
      widget.food.withPrimaryImageAt(_currentImageIndex);

  void _handleAddAndGoToCart() {
    widget.onAddToCart?.call(_selectedProductForCart);
  ...
  Widget build(BuildContext context) {
    ...
    final imageHeight = widget.preferExpandedImage
        ? (isMobile ? 200.0 : (isTablet ? 260.0 : 300.0))
        : (isMobile ? 145.0 : (isTablet ? 175.0 : 205.0));
    ...
    return MouseRegion(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: _isHovered ? AppColors.gold : palette.border,
          ),
          boxShadow: [
            BoxShadow(
          ...
          child: Column(
            ...
            children: [
              _FoodImageSection(
                ...
                height: imageHeight,
                isMobile: isMobile,
                preferExpandedImage: widget.preferExpandedImage,
                ...
                onAddToCart:
                    widget.food.isAvailable ? widget.onAddToCart : null,
...
class _PriceAndActionSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final palette =
        AppColors.palette(context.watch<ThemeController>().isDarkMode);
    final hasDiscount = entry.hasDiscount;
          ...
          ? Column(
              ...
              children: [
                ...
                if (hasDiscount) ...[
                  ...
                  Text(
                    'GHS ${entry.oldPrice!.toStringAsFixed(2)}',
                    style: TextStyle(
                      fontSize: 12,
                  ...
                  const SizedBox(height: 6),
                  _DealChip(label: '-${entry.discountPercent}%'),
                ],
...
class _FoodImageSection extends StatefulWidget {
  ...
  const _FoodImageSection({
    ...
    required this.isMobile,
    required this.preferExpandedImage,
                  ...
                  children: [
                    PageView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return Container(
                          color: widget.preferExpandedImage
                              ? palette.surfaceAlt
                              : palette.surface,
                          padding: EdgeInsets.all(
                            widget.preferExpandedImage
...
class _ProductGalleryDialogState extends State<_ProductGalleryDialog> {
  ...
  ProductItem get _selectedProductForCart =>
      widget.food.withPrimaryImageAt(_currentIndex);
        ...
        if (hasDiscount) ...[
          ...
          Wrap(
            ...
            children: [
              ...
              _DealChip(label: '-${entry.discountPercent}% OFF'),
            ],
          ),
        ],
        const SizedBox(height: 14),
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(
              ...
              height: 1.45,
              fontWeight: FontWeight.w600,
              color: valueColor ?? activePalette.textPrimary,
            ),
          ),
        ],
      ),
          ...
          children: [
            Icon(
              ...
              color: disabled
                  ...
                  : (isGold ? AppColors.primaryBlack : palette.textPrimary),
            ),
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: disabled ? palette.border : AppColors.gold,
          borderRadius: BorderRadius.circular(14),
          border: Border.all(
            color: disabled ? palette.border : AppColors.gold,
          ),
        ...
        child: Row(
          ...
          children: [
            Icon(
              ...
              size: isMobile ? 15 : 16,
              color: disabled ? palette.textSecondary : AppColors.primaryBlack,
            ),
            const SizedBox(width: 5),
            Text(
              disabled ? 'N/A' : 'Add',
