...
_DashboardActionCard(
  ...
  highlightValue: 'Logistics',
                      ...
                      _DashboardActionCard(
                        ...
                        subtitle:
                            'Control homepage promo copy, shop messaging, announcement text, and light or sharp blue-black dark mode.',
                        icon: Icons.tune_rounded,
                        accentIcon: Icons.palette_outlined,
                        buttonLabel: 'Open Settings',
                        page: AdminSettingsPage(),
                        highlightValue: 'Control',
                      ),
                      SizedBox(height: 16),
                      _DashboardActionCard(
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: data.highlight ? AppColors.gold : palette.border,
        ),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Container(
            ...
            child: Icon(
              data.icon,
              color: data.highlight ? AppColors.gold : palette.textPrimary,
              size: isMobile ? 20 : 22,
            ),
          ),
          const Spacer(),
      ...
      child: isMobile
              ...
              children: [
                ...
                ...stats.map(
                  (stat) => Padding(
                    ...
                    child: _HeroStatCard(data: stat, palette: palette),
                  ),
                ),
              ],
            )
          : Row(
              ...
              children: [
                Expanded(
                  flex: 3,
                  child: _HeroTopText(palette: palette),
                ),
