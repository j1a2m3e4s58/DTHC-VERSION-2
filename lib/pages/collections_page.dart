      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            _CollectionsHeroSection(palette: palette),
            if (allCollections.isEmpty)
              _CollectionsEmptyState(palette: palette)
            else ...[
      ...
      child: Center(
        child: ConstrainedBox(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(30),
              gradient: activePalette.heroGradient,
            ...
            child: isMobile
                    ...
                    children: [
                      _HeroBadge(),
                      SizedBox(height: 18),
                      _HeroTextBlock(isMobile: true, palette: activePalette),
                      SizedBox(height: 22),
                      _HeroStatsBlock(palette: activePalette),
                    ],
                  )
                      : Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ...
                      Expanded(
                        flex: 2,
                        child: _HeroStatsBlock(palette: activePalette),
                      ),
                    ],
                  ),
          ),
...
class _HeroTextBlock extends StatelessWidget {
  ...
  const _HeroTextBlock({required this.isMobile, this.palette});
    ...
    return Column(
      ...
      children: [
        Text(
          ...
          style: TextStyle(
            color: activePalette.textOnStrong,
...
class _HeroStatsBlock extends StatelessWidget {
  ...
  const _HeroStatsBlock({this.palette});
