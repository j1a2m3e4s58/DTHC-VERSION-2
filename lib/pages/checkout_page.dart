...
Navigator.pushReplacement(
                ...
                child: ConstrainedBox(
                  ...
                  child: isMobile
                      ? Column(
                          ...
                          children: [
                            _buildTopIntro(isMobile: true, palette: palette),
  ...
  Widget _buildPaymentInstructionCard(
    ...
    if (_selectedPaymentMethod == 'Mobile Money') {
      ...
      icon = Icons.phone_android_rounded;
      content = [
        _buildInstructionRow('MoMo Number', _momoNumber, palette: palette),
        const SizedBox(height: 10),
        _buildInstructionRow('Name', _accountName, palette: palette),
        const SizedBox(height: 10),
  ...
  Widget _buildInstructionRow(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(16),
        border: Border.all(
          color: highlight ? AppColors.gold : palette.border,
        ),
      ),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          Flexible(
            child: Text(
              ...
              style: TextStyle(
                color: highlight ? AppColors.gold : palette.textPrimary,
                fontWeight: FontWeight.w800,
                fontSize: 14,
              ),
            ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildSelectedZoneSummary(cartController, palette),
          ...
          const SizedBox(height: 10),
          _summaryAmountRow('Subtotal', cartController.subtotal, palette: palette),
          const SizedBox(height: 10),
          _summaryAmountRow(
            'Delivery Fee',
            _resolveDeliveryFee(cartController),
            palette: palette,
          ),
          const SizedBox(height: 10),
          _summaryAmountRow(
      ...
      children: [
        ...
        Text(
          ...
          style: TextStyle(
            ...
            color: isBold ? AppColors.gold : palette.textPrimary,
          ),
        ),
      ],
    );
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: AnimatedContainer(
        ...
        padding: const EdgeInsets.all(16),
        decoration: BoxDecoration(
          color: isSelected ? palette.surfaceStrong : palette.surface,
          borderRadius: BorderRadius.circular(18),
          border: Border.all(
          ...
          children: [
            Container(
              ...
              child: Icon(
                ...
                color: isSelected ? AppColors.primaryBlack : palette.textPrimary,
              ),
            ),
            const SizedBox(width: 14),
            Expanded(
