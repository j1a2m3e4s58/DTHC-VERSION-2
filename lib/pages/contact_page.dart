      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            _BrandSupportSection(palette: palette),
          ],
        ),
      ),
    );
            ...
            child: isMobile
                ? Column(
                    ...
                    children: [
                      ...
                      _HeroText(storeSettings: storeSettings, palette: palette),
          ...
          child: Container(
            ...
            child: width < 900
                ? Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      _QuickActionIntro(palette: activePalette),
                      const SizedBox(height: 18),
                      _QuickActionButtons(
                ...
                : Row(
                    children: [
                      Expanded(
                        child: _QuickActionIntro(palette: activePalette),
                      ),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isPrimary ? AppColors.gold : palette.border,
        ),
      ),
      child: Column(
        children: [
          Row(
            children: [
              Container(
                ...
                width: 52,
                decoration: BoxDecoration(
                  color: isPrimary ? AppColors.gold : palette.surface,
                  borderRadius: BorderRadius.circular(14),
                ),
                child: Icon(
                  icon,
        ...
        child: ConstrainedBox(
          ...
          child: isMobile
              ? Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    _ContactFormIntro(palette: activePalette),
                    const SizedBox(height: 22),
                    _ContactFormCard(
                      formKey: formKey,
                      nameController: nameController,
              ...
              : Row(
                  ...
                  children: [
                    Expanded(
                      child: _ContactFormIntro(palette: activePalette),
                    ),
                    const SizedBox(width: 24),
                    Expanded(
                      flex: 2,
    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          validator: validator,
          style: TextStyle(color: activePalette.textPrimary),
          decoration: InputDecoration(
            hintText: hint,
            hintStyle: TextStyle(color: activePalette.textSecondary),
            filled: true,
            fillColor: activePalette.surface,
