...
class MockStoreData {
  static StoreSettings storeSettings = const StoreSettings(
    ...
    themeMode: 'light',
    homeSearchTitle: 'Search DTHC',
    homeSearchSubtitle:
        'Live product search with quick image results for a more premium shopping flow.',
    marketplaceBannerLabel: 'HOT DEALS',
    marketplaceBannerTitle: 'Big style picks for this week',
    marketplaceBannerSubtitle:
        'Browse fresh drops, fast-moving best sellers, and sharp everyday essentials in one quick shopping lane.',
    marketplacePrimaryCta: 'Shop New Drops',
    marketplaceSecondaryCta: 'Open Best Sellers',
    promoSneakersTitle: 'Sneaker Picks',
    promoSneakersSubtitle: 'Clean runners and standout colorways.',
    promoSneakersCta: 'Shop Sneakers',
    promoTeesTitle: 'Graphic Tees',
    promoTeesSubtitle: 'Street-ready tops for daily rotation.',
    promoTeesCta: 'Shop Tees',
    promoBestSellersTitle: 'Best Sellers',
    promoBestSellersSubtitle: 'The fastest-moving products on the store.',
    promoBestSellersCta: 'Open Best Sellers',
    dealsStripLabel: 'FLASH SALE',
    dealsStripTitle: 'The latest DTHC drop is live.',
    dealsStripSubtitle:
        'Push visitors straight into the strongest buying paths: fresh arrivals and exclusive premium pieces.',
    dealsPrimaryCta: 'Shop New Drops',
    dealsSecondaryCta: 'Open Limited Edition',
    dealsCountdownEndsAt: '2026-04-07T18:00:00',
    shopHeaderBadge: 'SHOP',
  ...
  static List<ProductItem> foodItems = [
    const ProductItem(
      ...
      oldPrice: 150,
      dealLabel: 'Best Deal',
      dealEndsAt: '2026-04-06T23:00:00',
      isAvailable: true,
      isFeatured: true,
      stockQuantity: 25,
    ...
    const ProductItem(
      ...
      dealEndsAt: '2026-04-05T21:00:00',
      isAvailable: true,
      isFeatured: true,
      stockQuantity: 18,
    ...
    const ProductItem(
      ...
      oldPrice: 380,
      dealLabel: 'Hot Drop',
      dealEndsAt: '2026-04-08T20:00:00',
      isAvailable: true,
      isFeatured: true,
      stockQuantity: 12,
    ...
    const ProductItem(
      ...
      oldPrice: 340,
      dealLabel: 'Limited Offer',
      dealEndsAt: '2026-04-09T16:00:00',
      isAvailable: true,
      isFeatured: true,
      stockQuantity: 10,
      collection: 'Urban Motion',
